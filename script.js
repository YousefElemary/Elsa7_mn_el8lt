...
const CHATBOT_KNOWLEDGE = `
    ...
    - فريق التطوع الأساسي (الظاهر في تشكيلة الموقع) يضم 12 شخصاً موزعين على أقسام: البرمجة، الميديا، التصوير الفوتوغرافي، مونتاج الفيديو، والتنظيم. بالإضافة إلى ذلك يوجد فريق احتياطي أوسع (حوالي 15 متطوعاً إضافياً) موزع على نفس اللجان.
